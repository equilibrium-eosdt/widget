...
var scatterjs_core_1 = __importDefault(require("scatterjs-core"));
var scatterjs_plugin_eosjs2_1 = __importDefault(require("scatterjs-plugin-eosjs2"));
var network = {
    blockchain: "eos",
    protocol: "https",
    host: "api.eosn.io",
            ...
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        ...
                        return [4, scatterjs_core_1.default.scatter.connect(this.dappName, connectionOptions)];
                    case 1:
                        connected = _a.sent();
                        if (!connected) {
