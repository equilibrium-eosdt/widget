...
function Tabs(params) {
    var _this = this;
    var id = params.id, tabs = params.tabs, className = params.className, onSelect = params.onSelect;
    var type = {
        state: { tabIndex: 0 },
        ...
        onUpdate: function (w, state) { return __awaiter(_this, void 0, void 0, function () {
            return __generator(this, function (_a) {
                switch (_a.label) {
                    case 0:
                        if (!(state.tabIndex !== w.state.tabIndex)) return [3, 2];
                        return [4, onSelect()];
                    case 1:
                        _a.sent();
                        _a.label = 2;
        ...
        render: function (state, r) {
            ...
            return r(templateObject_3 || (templateObject_3 = __makeTemplateObject(["\n      <div class=\"equil-position-manage__tabs-wrapper\">\n        <!-- span>I want to </span -->\n        <div class=\"equil-position-manage__dropdownMenu\">\n          <!-- div class=\"equil-position-manage__activeTab\">\n          ", "\n          </div -->\n          <ul class=\"equil-position-manage__tabs\">\n            ", "\n          </ul>\n        </div>\n      </div>\n  ", "\n"], ["\n      <div class=\"equil-position-manage__tabs-wrapper\">\n        <!-- span>I want to </span -->\n        <div class=\"equil-position-manage__dropdownMenu\">\n          <!-- div class=\"equil-position-manage__activeTab\">\n          ", "\n          </div -->\n          <ul class=\"equil-position-manage__tabs\">\n            ",
                ...
                return r(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n              <li class=\"", "", "-tab equil-position-manage__tab\">\n                ", "\n              </li>\n          "], ["\n              <li class=\"",
                    "", "-tab equil-position-manage__tab\">\n                ", "\n              </li>\n          "])), index === state.tabIndex
                    ? "equil-position-manage__tab--active "
                    : "", id, typeof name === "function" ? name() : name);
            })
