...
function createForm(params) {
    var _this = this;
    var id = params.id, className = params.className, fields = params.fields, handler = params.handler, validate = params.validate;
    var Form = {
        state: {
            pending: false,
            submitButton: button_1.default({ name: globals_1.t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["OK"], ["OK"]))), submit: true, className: "button" }),
            validate: {},
        },
        ...
        onUpdate: function (w, state) { return __awaiter(_this, void 0, void 0, function () {
            var el, onSubmit, _i, fields_1, field, input;
            return __generator(this, function (_a) {
                el = w.find();
        ...
        render: function (state, r) {
            return r(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n", "\n", "\n", "\n", "\n"], ["\n", "\n",
                "\n", "\n", "\n"])), state.pending ? "<p class=\"position-manage__pending\">Loading...</p>" : "", fields
                .map(function (name) {
                return "<input class=\"input " + (state.error &&
                    "input--error") + "\" type=\"text\" name=\"" + name + "\" />";
            })
                .join(""), state.error ? "<p class=\"position-manage__error\">" + state.error + "</p>" : "", state.submitButton);
        },
    };
