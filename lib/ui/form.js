...
function createForm(params) {
    var _this = this;
    var id = params.id, className = params.className, fields = params.fields, handler = params.handler, validate = params.validate, label = params.label;
    var Form = {
        state: {
            pending: false,
        ...
        render: function (state, r) {
            return r(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n", "\n", "\n", "\n", "\n"], ["\n", "\n",
                "\n", "\n", "\n"])), state.pending ? "<span class=\"position-manage__pending\">Loading...</span>" : "", fields.map(function (name, i) {
            ...
            }).join(""), state.error ? "<span class=\"position-manage__error\">" + state.error + "</span>" : "", state.submitButton);
        },
    };
