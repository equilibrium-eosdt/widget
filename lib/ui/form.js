        ...
        render: function (state, r) {
            return r(templateObject_2 || (templateObject_2 = __makeTemplateObject(["\n", "\n", "\n", "\n", "\n"], ["\n",
                ...
                return "<div class=\"equil-position-manage__input-wrapper\">\n    " + (label
                    ? "<label class=\"equil-position-manage__input-label\">" + label[i] + "</label>"
                    : "") + "\n    <input class=\"equil-position-manage__input " + (state.error ? "equil-position-manage__input--error" : null) + "\"}\" placeholder=\"0.00\" type=\"number\" autocomplete=\"off\" name=\"" + name + "\" />\n  </div>";
            })
                .join(""), state.error
