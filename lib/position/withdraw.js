                            ...
                            amount: function (value) {
                                ...
                                if (Number(value) > Number(maxToWithdraw)) {
                                    var max = maxToWithdraw
                                        ...
                                        : 0;
                                    return globals_1.t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["EOS amount withdrawn should not be more than ", ""], ["EOS amount withdrawn should not be more than ", ""])), max);
                                }
                                else if (Number(value) > 100000000) {
                                    return globals_1.t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Withdraw amount cannot exceed 100000000."], ["Withdraw amount cannot exceed 100000000."])));
                                }
                                else
                                    return;
                            },
