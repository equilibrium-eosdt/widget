                            ...
                            return __generator(this, function (_b) {
                                switch (_b.label) {
                                    ...
                                    case 1:
                                        ...
                                        return [3, 3];
                                    case 2: throw new Error(globals_1.t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Wrong data"], ["Wrong data"]))));
                                    case 3: return [3, 5];
                                    case 4: throw new Error(globals_1.t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["No data"], ["No data"]))));
                                    case 5: return [2];
                                }
                            });
                        }); },
