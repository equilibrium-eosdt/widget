...
var ManagePosition = {
    ...
    render: function (state, r) {
        ...
        if (!Array.isArray(positions) || positions.length < 1) {
            return r(templateObject_12 || (templateObject_12 = __makeTemplateObject(["<h2 class=\"position-manage__title\">", "</h2>", ""], ["<h2 class=\"position-manage__title\">", "</h2>",
                ""])), globals_1.t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Create new position"], ["Create new position"]))), {
                id: "create-position",
        ...
        if (!rate) {
            throw new Error(globals_1.t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["No USD rate"], ["No USD rate"]))));
        }
        ...
        return r(templateObject_21 || (templateObject_21 = __makeTemplateObject(["\n  <p class=\"eos-collateralized\">\n    ", "\n    ", " EOS\n  </p>\n  <p class=\"eosdt-generated\">\n    ", "\n    ", " EOSDT\n  </p>\n  <h2 class=\"position-manage__title\">\n    ", "\n  </h2>\n  ", "\n  <p class=\"ltv\">\n    ", "\n    ", "%\n  </p>\n  <p class=\"rate\">\n    ", "\n    ", "$\n  </p>\n  <p class=\"max-to-withdraw\">\n    ", "\n    ", " EOS\n  </p>\n  <p class=\"max-to-generate\">\n    ", "\n    ", " EOSDT\n  </p>\n"], ["\n  <p class=\"eos-collateralized\">\n    ", "\n    ", " EOS\n  </p>\n  <p class=\"eosdt-generated\">\n    ", "\n    ", " EOSDT\n  </p>\n  <h2 class=\"position-manage__title\">\n    ",
            "\n  </h2>\n  ", "\n  <p class=\"ltv\">\n    ", "\n    ", "%\n  </p>\n  <p class=\"rate\">\n    ", "\n    ", "$\n  </p>\n  <p class=\"max-to-withdraw\">\n    ", "\n    ", " EOS\n  </p>\n  <p class=\"max-to-generate\">\n    ", "\n    ", " EOSDT\n  </p>\n"])), globals_1.t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Total collateralized:"], ["Total collateralized:"]))), eos.toFixed(4), globals_1.t(templateObject_15 || (templateObject_15 = __makeTemplateObject(["Debt generated:"], ["Debt generated:"]))), eosdt.toFixed(2), globals_1.t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["Manage position of <i class=\"position-manage__username\">", "</i>"], ["Manage position of <i class=\"position-manage__username\">",
            "</i>"])), account.name), state.tabs, globals_1.t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Collateralization ratio:"], ["Collateralization ratio:"]))), (ltv * 100).toFixed(), globals_1.t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Liquidation price:"], ["Liquidation price:"]))), minRate.toFixed(2), globals_1.t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Max EOS to withdraw:"], ["Max EOS to withdraw:"]))), maxEos.toFixed(4), globals_1.t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Max EOSDT to generate:"], ["Max EOSDT to generate:"]))), maxEosdt.toFixed(2));
    },
};
