...
var ManagePosition = {
    ...
    onInit: function (w) { return __awaiter(_this, void 0, void 0, function () {
        var _a, client, events, rawAccount, account, contract, name, params, positions, rates, settings, balance, userBalanceArray, userBalanceEos, EosRate, NutRate, getNutBalance, userBalanceNut, getEosdtBalance, userBalanceEosdt, getNUTAmount, tabs;
        var _this = this;
        return __generator(this, function (_b) {
            switch (_b.label) {
                ...
                case 7:
                    getNutBalance = _b.sent();
                    userBalanceNut = getNutBalance.length
                        ? parseFloat(getNutBalance[0])
                        : 0;
                    return [4, client.rpc.get_currency_balance("eosdtsttoken", "" + account.name, "EOSDT")];
                case 8:
                    getEosdtBalance = _b.sent();
                    userBalanceEosdt = getEosdtBalance.length
    ...
    onUpdate: function (w) { return __awaiter(_this, void 0, void 0, function () {
        var state, params, rates, settings, balance, rate, stability_rate, _a, outstanding, collateral, k, eos, eosdt, usd, minLtv, maxEos, maxEosdt;
        return __generator(this, function (_b) {
            state = w.state;
            params = state.params, rates = state.rates, settings = state.settings, balance = state.balance;
            rate = rates.find(function (rate) { return rate.rate.indexOf("USD") >= 0; });
            if (!rate) {
                throw new Error(globals_1.t(templateObject_6 || (templateObject_6 = __makeTemplateObject(["No USD rate"], ["No USD rate"]))));
            }
            stability_rate = params.stability_rate;
            _a = state.positions[0], outstanding = _a.outstanding, collateral = _a.collateral;
            k = balance
            ...
            if (maxEos !== w.state.maxEos || maxEosdt !== w.state.maxEosdt) {
                w.update({ maxEos: maxEos, maxEosdt: maxEosdt });
            }
            if (eosdt !== w.state.eosdt) {
                w.update({ eosdt: eosdt });
            }
            return [2];
        });
    }); },
    render: function (state, r) {
        ...
        if (!account) {
            return globals_1.t(templateObject_7 || (templateObject_7 = __makeTemplateObject(["Waiting for account..."], ["Waiting for account..."])));
        }
        if (!contract) {
            return globals_1.t(templateObject_8 || (templateObject_8 = __makeTemplateObject(["Waiting for contract..."], ["Waiting for contract..."])));
        }
        if (!params) {
            return globals_1.t(templateObject_9 || (templateObject_9 = __makeTemplateObject(["Waiting for params..."], ["Waiting for params..."])));
        }
        if (!rates) {
            return globals_1.t(templateObject_10 || (templateObject_10 = __makeTemplateObject(["Waiting for rates..."], ["Waiting for rates..."])));
        }
        if (!balance || !balance[0]) {
            return globals_1.t(templateObject_11 || (templateObject_11 = __makeTemplateObject(["Waiting for contract balance..."], ["Waiting for contract balance..."])));
        }
        if (!Array.isArray(positions) || positions.length < 1) {
            return r(templateObject_15 || (templateObject_15 = __makeTemplateObject(["\n      <div class=\"equil-position-actions\">\n        <h2 class=\"equil-position-manage__title\">", "</h2>", "\n      </div>\n      <div class=\"equil-position-parameters equil-position-parameters--empty\">\n        <h2 class=\"equil-position-manage__title\">", "</h2>\n          <span class=\"equil-position-parameters__title\">", "</span>\n      </div>"], ["\n      <div class=\"equil-position-actions\">\n        <h2 class=\"equil-position-manage__title\">", "</h2>",
                "\n      </div>\n      <div class=\"equil-position-parameters equil-position-parameters--empty\">\n        <h2 class=\"equil-position-manage__title\">", "</h2>\n          <span class=\"equil-position-parameters__title\">", "</span>\n      </div>"])), globals_1.t(templateObject_12 || (templateObject_12 = __makeTemplateObject(["Create position"], ["Create position"]))), {
                id: "create-position",
                type: create_1.default({ account: account, contract: contract }),
            }, globals_1.t(templateObject_13 || (templateObject_13 = __makeTemplateObject(["You don't have any positions yet"], ["You don't have any positions yet"]))), globals_1.t(templateObject_14 || (templateObject_14 = __makeTemplateObject(["Deposit collateral and generate <br/>debt to get started"], ["Deposit collateral and generate <br/>debt to get started"]))));
        }
        var rate = rates.find(function (rate) { return rate.rate.indexOf("USD") >= 0; });
        if (!rate) {
            throw new Error(globals_1.t(templateObject_16 || (templateObject_16 = __makeTemplateObject(["No USD rate"], ["No USD rate"]))));
        }
        ...
        return r(templateObject_25 || (templateObject_25 = __makeTemplateObject(["\n      <div class=\"equil-position-actions\">\n        <h2 class=\"equil-position-manage__title\">\n          ", "\n        </h2>\n        <div class=\"equil-position-actions__labels\">\n          <div class=\"equil-position-actions__label\">\n            <span>", "</span>\n            <span class=\"equil-position-actions__value\">", "</span>\n          </div>\n          <div class=\"equil-position-actions__label\">\n            <span>", "</span>\n            <span class=\"equil-position-actions__value\">", "</span>\n          </div>\n        </div>\n        ", "\n      </div>\n      <div class=\"equil-position-parameters\">\n        <h2 class=\"equil-position-manage__title\">", "</h2>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">", "%</span>\n        </div>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">", "$</span>\n        </div>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">", " EOS</span>\n        </div>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">", " EOSDT</span>\n        </div>\n      </div>\n"], ["\n      <div class=\"equil-position-actions\">\n        <h2 class=\"equil-position-manage__title\">\n          ",
            "\n        </h2>\n        <div class=\"equil-position-actions__labels\">\n          <div class=\"equil-position-actions__label\">\n            <span>", "</span>\n            <span class=\"equil-position-actions__value\">", "</span>\n          </div>\n          <div class=\"equil-position-actions__label\">\n            <span>", "</span>\n            <span class=\"equil-position-actions__value\">",
            "</span>\n          </div>\n        </div>\n        ", "\n      </div>\n      <div class=\"equil-position-parameters\">\n        <h2 class=\"equil-position-manage__title\">", "</h2>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">",
            "%</span>\n        </div>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">",
            "$</span>\n        </div>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">",
            " EOS</span>\n        </div>\n        <div class=\"equil-position-parameters__item\">\n          <span class=\"equil-position-parameters__title\">", "</span>\n          <span class=\"equil-position-parameters__value\">",
            " EOSDT</span>\n        </div>\n      </div>\n"])), globals_1.t(templateObject_17 || (templateObject_17 = __makeTemplateObject(["Manage position of <i class=\"equil-position-manage__username\">", "</i>"], ["Manage position of <i class=\"equil-position-manage__username\">",
            "</i>"])), account.name), globals_1.t(templateObject_18 || (templateObject_18 = __makeTemplateObject(["Collateral EOS"], ["Collateral EOS"]))), eos.toFixed(4), globals_1.t(templateObject_19 || (templateObject_19 = __makeTemplateObject(["Debt EOSDT"], ["Debt EOSDT"]))), eosdt.toFixed(2), state.tabs, globals_1.t(templateObject_20 || (templateObject_20 = __makeTemplateObject(["Position parameters"], ["Position parameters"]))), globals_1.t(templateObject_21 || (templateObject_21 = __makeTemplateObject(["Collateralization ratio:"], ["Collateralization ratio:"]))), (ltv * 100).toFixed(), globals_1.t(templateObject_22 || (templateObject_22 = __makeTemplateObject(["Liquidation price:"], ["Liquidation price:"]))), minRate.toFixed(2), globals_1.t(templateObject_23 || (templateObject_23 = __makeTemplateObject(["Max EOS to withdraw:"], ["Max EOS to withdraw:"]))), maxEos.toFixed(4), globals_1.t(templateObject_24 || (templateObject_24 = __makeTemplateObject(["Max EOSDT to generate:"], ["Max EOSDT to generate:"]))), maxEosdt.toFixed(2));
    },
};
