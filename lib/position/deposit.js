                        ...
                        validate: {
                            amount: function (value) {
                                ...
                                if (Number(value) > 100000000) {
                                    return globals_1.t(templateObject_1 || (templateObject_1 = __makeTemplateObject(["Deposit amount cannot exceed 100000000."], ["Deposit amount cannot exceed 100000000."])));
                                }
                                if (Number(value) > Number(maxToDeposit)) {
                                    var max = maxToDeposit ? Number(maxToDeposit).toFixed(4) : 0;
                                    return globals_1.t(templateObject_2 || (templateObject_2 = __makeTemplateObject(["Value should not exceed your balance of ", " EOS"], ["Value should not exceed your balance of ", " EOS"])), max);
                                }
                                else
                                    return;
                            },
